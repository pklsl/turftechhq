...
description: "Discover how to tell moles from voles, and learn the most effective trapping, baiting, and habitat modification strategies to reclaim your lawn and garden."
pubDate: 2026-04-21
...
1. **Probe the ridges:** Push a stick or finger into raised turf ridges. Mole surface tunnels are open cavities just under the sod. Vole runways are on the surface — matted-down channels through grass.
2. **Look for surface paths:** Get down low and look across your lawn on a bright morning. Vole runways are often visible as slightly depressed, worn pathways through grass — especially noticeable in taller grass areas.
3. **Check plant bases:** Pull back mulch around the base of shrubs and perennials. Chewed bark is a definitive sign of voles.
4. **Examine mounds:** If dirt mounds are present, a mole is nearly certain. True voles don't create mounds.
5. **Squish a tunnel:** Press down a mole surface tunnel and mark it. Check in 24 hours — if it's been re-raised, a mole is actively using it. This also identifies active tunnels for trap placement.
...
- **[Victor Out O'Sight Mole Trap](https://www.amazon.com):** The classic scissor-jaw design, widely available and proven over decades of use. Works best in soft soils.
...
- **[Victor Harpoon Mole Trap](https://www.amazon.com):** Durable, easy to set, and very effective in firmer soils where scissor-jaw traps can't close properly.
...
**[Talpirid Mole Bait](https://www.amazon.com)** is a professional-grade bait designed to look and feel like an earthworm — the mole's preferred food source. It contains bromethalin, a neurotoxin effective in very small quantities.

**How to use Talpirid:**

1. Locate an active tunnel (use the flatten-and-check method above)
2. Use a screwdriver or probe to make a small hole in the tunnel roof
3. Drop one Talpirid worm bait into the tunnel using gloves — human scent on the bait can deter suspicious moles
4. Mark the bait location and check in 5–7 days
5. If bait hasn't been disturbed, move to a different tunnel
...
- **[Victor Original Snap Trap](https://www.amazon.com)** or **[Tomcat Snap Traps](https://www.amazon.com):** Reliable, inexpensive, and easy to reset. Set traps perpendicular to vole runways so the trigger is directly in the animal's path.
...
For large-scale vole infestations, **zinc phosphide** and **anticoagulant rodenticide bait stations** are highly effective. These are available to homeowners under product names like **[Ditrac Ground Squirrel and Vole Bait](https://www.amazon.com)**.
