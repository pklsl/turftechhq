---
title: "How to Prune Trees and Shrubs: A Complete Guide"
description: "Learn how to prune trees and shrubs the right way — the best tools, timing, and techniques to keep your plants healthy, safe, and looking great year-round."
pubDate: 2026-04-21
...
1. Identify an outward-facing bud (growth will emerge in the direction the bud points).
2. Make the cut at a **45-degree angle**, slanting away from the bud.
3. Position the cut about **1/4 inch above the bud** — close enough that no stub remains, but far enough that the bud won't dry out.

### Removing Entire Branches (Thinning Cut)
When removing a branch back to the trunk or a main limb:
1. Locate the **branch collar** — the slightly swollen, wrinkled zone where the branch meets the trunk. This tissue contains specialized cells that seal wounds.
2. Make your cut just outside the branch collar, angling slightly away from the trunk.
3. **Never make flush cuts** — removing the branch collar destroys the tree's ability to compartmentalize the wound and dramatically increases decay risk.
...
1. **Undercut:** 12-18 inches from the trunk, cut upward about 1/3 of the way through the branch.
2. **Top cut:** A few inches farther out from the trunk, cut downward all the way through. The limb will break cleanly at the undercut.
